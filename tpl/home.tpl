...
<body>
	<h1>Italian universities information</h1>
	<h3><a href="/noscript">home</a></h3>
	...
	<div style="display:(:showNames ~ none:)"> (:names ~
		<h3><a href="/noscript?uni=[:name:]">[:name:]</a></h3> :) </div>
	...
	<div style="display:(:showUni ~ none:)"> (:uni ~
		<h3>[:name:]</h3>
		...
		<h3>% of fluent english speakers: [:english_knownledge:]</h3> :) </div>
</body>
